          ...
          <div className="flex justify-center mb-4 gap-2 w-full lg:w-auto">
            ...
            <div className="hidden lg:flex flex-wrap gap-4">
              <button
                ...
                className={`${filterScene === "all" ? "bg-secondaryColor text-bgColor border-bgColor" : "bg-bgColor text-secondaryColor border-inputFieldColor"} rounded-lg border-2 transition-colors duration-100 ease-in-out hover:bg-secondaryColor hover:text-bgColor hover:border-bgColor px-4 py-1 :ring-2 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-accentColor`}
              >
                All Scenes
              </button>
              {Object.keys(schedule).map((scene) => (
                <button
                  ...
                  className={`${filterScene === scene ? "bg-secondaryColor text-bgColor border-bgColor" : "bg-bgColor text-secondaryColor border-inputFieldColor"} rounded-lg border-2 transition-colors duration-100 ease-in-out hover:bg-secondaryColor hover:text-bgColor hover:border-bgColor px-4 py-1 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-accentColor`}
                >
                  {scene}
                </button>
              ))}
            ...
            <div className="hidden lg:flex flex-wrap gap-4">
              {lineUpDays.map((day) => (
                <button
                  ...
                  className={`${filterDay === day ? "bg-secondaryColor text-bgColor border-bgColor" : "bg-bgColor text-secondaryColor border-inputFieldColor"} rounded-lg border-2 transition-colors duration-100 ease-in-out hover:bg-secondaryColor hover:text-bgColor hover:border-bgColor px-4 py-1 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-accentColor`}
                >
                  {days[day]}
                </button>
              ))}
              ...
              <ul className="col-start-2 col-end-5 w-full">
                {groupedByTime[time].map((act) => (
                  <li
                    ...
                    tabIndex={0}
                    className="flex justify-between overflow-hidden w-full h-24 md:h-40 border-b border-primaryTextColor last:border-b-0 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-accentColor"
                  >
                    <Link
                      href={act.band?.slug || "#"}
                      prefetch={false}
